          ...
          <div className="w-full flex flex-col gap-y-1 pb-6 border-white border-b-2 border-opacity-10">
            <div className="items-center flex gap-x-4">
              <p className="text-lg leading-6 font-bold text-white">
                {t("liveDocumentSyncManager.title")}
              </p>
            </div>
            <p className="text-xs leading-[18px] font-base text-white text-opacity-60">
              {t("liveDocumentSyncManager.description")}
            </p>
          </div>
      ...
      <thead className="text-white text-opacity-80 text-xs leading-[18px] font-bold uppercase border-white border-b border-opacity-60">
        <tr>
          <th scope="col" className="px-6 py-3 rounded-tl-lg">
            {t("liveDocumentSyncManager.documentName")}
          </th>
          <th scope="col" className="px-6 py-3">
            {t("liveDocumentSyncManager.lastSynced")}
          </th>
          <th scope="col" className="px-6 py-3">
            {t("liveDocumentSyncManager.timeUntilNextRefresh")}
          </th>
          <th scope="col" className="px-6 py-3">
            {t("liveDocumentSyncManager.createdOn")}
          </th>
