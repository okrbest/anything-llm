...
export default function AvailableAgentsButton({ showing, setShowAgents }) {
  ...
  return (
    <div
      ...
      data-tooltip-content={t("availableAgentsButton.tooltip")}
      aria-label={t("availableAgentsButton.tooltip")}
            ...
            >
              <div className="w-full flex-col text-left flex pointer-events-none">
                <div className="text-white text-sm">
                  <b>@agent</b> - {t("availableAgentsButton.agent")}
                </div>
                <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  <AbilityTag text={t("abilities.saveFileToBrowser")} />
            ...
            >
              <div className="w-full flex-col text-center flex pointer-events-none">
                <div className="text-white text-xs text-white/50 italic">
                  {t("availableAgentsButton.customAgentsComingSoon")}
                </div>
              </div>
            </button>
          </div>
        ...
        <div className="relative bg-main-gradient rounded-lg shadow">
          <div className="flex items-center gap-x-1 justify-between p-4 border-b rounded-t border-gray-600">
            ...
            <h3 className="text-xl font-semibold text-white">
              {t("availableAgentsButton.firstTimeModal.title")}
            </h3>
            <button
              onClick={dismiss}
              type="button"
          ...
          <div className="p-6 space-y-6 flex h-full w-full">
            <div className="w-full flex flex-col gap-y-4">
              <p className="text-white/80 text-xs md:text-sm">
                {t("availableAgentsButton.firstTimeModal.description")}
              </p>
              <p className="text-green-300/60 text-xs md:text-sm">
                {t("availableAgentsButton.firstTimeModal.earlyAccess")}
              </p>
            </div>
          </div>
          <div className="flex w-full justify-between items-center p-6 space-x-2 border-t rounded-b border-gray-600">
            ...
            >
              {t("availableAgentsButton.firstTimeModal.continueButton")}
            </button>
          </div>
        </div>
      </div>
