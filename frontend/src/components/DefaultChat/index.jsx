...
export default function DefaultChatContainer() {
  ...
  const popMsg = !window.localStorage.getItem("teamplgpt_intro");
  ...
  useEffect(() => {
    function processMsgs() {
      if (!!window.localStorage.getItem("teamplgpt_intro")) {
      ...
      window.localStorage.setItem("teamplgpt_intro", 1);
    }
