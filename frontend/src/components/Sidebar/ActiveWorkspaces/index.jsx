                  ...
                  <div className="flex flex-row justify-between w-full">
                    <div className="flex items-center space-x-2">
                      <SquaresFour
                        ...
                        size={24}
                      />
                      <p className="text-[14px] leading-loose whitespace-nowrap overflow-hidden text-white">
                  ...
                  <div className="flex flex-row justify-between w-full">
                    <div className="flex items-center space-x-2">
                      <SquaresFour
                        ...
                        size={24}
                      />
                      <p className="text-[14px] leading-loose whitespace-nowrap overflow-hidden text-zinc-200">
                        {isHovered
                          ? truncate(workspace.name, 15)
