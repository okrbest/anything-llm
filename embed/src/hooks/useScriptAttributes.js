...
const DEFAULT_SETTINGS = {
  ...
  sponsorText: "Powered by TeamplGPT", // default sponsor text
  sponsorLink: "https://useanything.com", // default sponsor link
  position: "bottom-right", // position of chat button/window
  assistantName: "TeamplGPT Chat Assistant", // default assistant name
  ...
  useEffect(() => {
    function fetchAttribs() {
      ...
      if (
        ...
        throw new Error(
          "[TeamplGPT Embed Module::Abort] - Invalid script tag setup detected. Missing required parameters for boot!"
        );
